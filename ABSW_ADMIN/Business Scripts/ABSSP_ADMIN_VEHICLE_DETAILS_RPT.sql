...
AS
  SELECT 
   ...
   -- ,WK.ADM_VEH_MAINT_TRANS_NO AS RPT_VEH_TRANS_NO
    ...
    , (SELECT ADM_TAB_ITEM_DESC FROM ADM_MAINT_CODE_TABLE WHERE ADM_TAB_ITEM_CODE_NO = ADM_VEH_MAINT_VEH_NO  AND ADM_TAB_CLASS_CODE = '001') AS RPT_VEH_USER
    , (SELECT ADM_COD_TRANS_TYPE FROM [ADM_MAINT_CODE_TABLE] WHERE ADM_TAB_ITEM_CODE_NO = ADM_VEH_MAINT_SERVICE_COY AND ADM_TAB_CLASS_CODE = '002') AS RPT_VEH_TYPE
    , (SELECT ADM_TAB_ITEM_DESC FROM [ADM_MAINT_CODE_TABLE] WHERE ADM_TAB_ITEM_CODE_NO = ADM_VEH_MAINT_SERVICE_COY AND ADM_TAB_CLASS_CODE = '002') AS RPT_SERVICE_COY_NAME
