<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AD150.aspx.vb" Inherits="ABSW_ADMIN.AD150" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Diesel Record</title>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#txtTransRate").on('focusout', function(e) {
            e.preventDefault();
            document.getElementById("txtTransAmt").value = $("#txtTransQty").val() * $("#txtTransRate").val();
        ...
        <tr>
            <td colspan="7" valign="top">
                <table align="left" width="100%">
                    ...
                    <tr>
                        <td align="right" valign="top"><asp:Label ID="lblTransQty" Text="Quantity Supply:" runat="server"></asp:Label>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td valign="top"><asp:TextBox ID="txtTransAmt" MaxLength="15" runat="server" Enabled="False"></asp:TextBox>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td valign="top"><asp:DropDownList ID="cmbServiceComp" Width="300" runat="server"></asp:DropDownList><asp:TextBox ID="txtServiceComp"  Width="300"  runat="server" Visible=false></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" valign="top">&nbsp;</td>
